<form id="form_edit_factura" method="POST">
{{ csrf_field() }} {{ method_field('PATCH') }}
<div class="modal fade" id="editar_factura">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-orange">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span></button>
            <h4 class="modal-title"><i class="fa fa-arrow-right"></i> Editar factura</h4>
      </div>
      <div class="modal-body">
        <div class="form-group col-lg-4">
            <label0>Nº factura *</label>
            <input type="text" name="num_factura" class="form-control" id="n_factura" required="">
        </div>
        <div class="form-group col-lg-4">
      ...
      <div class="modal-footer">
        <div class="col-lg-12">
            ...
            <button type="submit" class="btn btn-warning" id="btn_edit_factura"><i class="fa fa-edit"></i> Guardar</button>
        </div>
      </div>
    </div>
  </div>
