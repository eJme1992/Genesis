<form id="form_add_pago" accept-charset="utf-8">
{{ csrf_field() }}
<div class="modal fade" id="add_pago">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="col-lg-12">
            ...
            <button type="submit" class="btn btn-success btn_ap"><i class="fa fa-save"></i> Guardar</button>
        </div>
      </div>
    </div>
  </div>
