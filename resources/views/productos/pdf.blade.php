...
.margin-abajo
{
    ...
    <body class="fondo_blanco">
        <div class="">
            <div class="row">
                <div class="col-sm-12">
                	<h1 class="page-header text-center" style="border-top: 1px solid #eee; border-bottom: 1px solid #7C7C7C;">
                		<span class="text-capitalize">Distribuidora Genesis E.I.R.L</span>
                	</h1>
      				    <table class="table table-bordered table-condensed">
                            ...
                            <td>00{{ $producto->coleccion->id }}</td>
                            <td>{{ $producto->coleccion->name }}</td>
                            <td>
                              @foreach($producto->coleccion->cm as $marcas)
                                <span class="col-sm-4"><b>*</b> {{ $marcas->marca->name }} |</span>
                                <span class="col-sm-4">Ruedas ({{ $marcas->rueda }})</span>
                                <span class="col-sm-4"> Modelos({{ $marcas->marca->mc($producto->coleccion->id, $marcas->marca->id) }})</span>
                              <br>
                              @endforeach
                            </td>
                            <td>{{ $producto->fecha_almacen }}</td>
      				            </tr>
      				        </tbody>
      				    </table>
                </div>
        ...
        <footer class="margin-abajo text-center">
          <div class="row">
            <div class="col-sm-12">
                {!! DNS1D::getBarcodeHTML($producto->coleccion->name, "C128B") !!}
            </div>
          </div>
        </footer>
    </body>
